...
You will also need to install a treesitter grammar for any language you want to create a parser for.

For Odin I recommend https://github.com/tree-sitter-grammars/tree-sitter-odin

This can be installed by running `odin run build -- install-parser -parser:https://github.com/tree-sitter-grammars/tree-sitter-odin` in the `/vendor/odin-tree-sitter` directory.
